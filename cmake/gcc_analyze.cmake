...
if(TUM_UI_STATIC_ANALYZE)
    if(TUM_UI_ENABLE_LINTING)
        message(FATAL_ERROR "Linting and the GCC static analysis can not be enabled at the same time! Disable either TUM_UI_STATIC_ANALYZE or TUM_UI_ENABLE_LINTING.")
    endif()
